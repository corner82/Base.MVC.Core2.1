 ...
 * dil seçeneðinin çalýþmasýný engelliyordu. Ýos cookie problemi çözülünce 
 * kod bloðu kullanýlabilir.
 */
...
$(document).ready(function () {
    $("#menu_search").on("keyup", function () {
        if (this.value.length > 0) {
            $("ul.sidebar-menu>li").hide().filter(function () {
                return $(this).text().toLowerCase().indexOf($("#menu_search").val().toLowerCase()) != -1;
            }).show();
        ...
        if (this.value.length > 0) {
            $("ul.treeview-menu>li").hide().filter(function () {
                return $(this).text().toLowerCase().indexOf($("#menu_search").val().toLowerCase()) != -1;
            }).show();
            //ul.treeview-menu menu-open>li
        }
        else {
            $("ul.treeview-menu>li").show();
        }
    });
...
$(window).on('load', function () {
    ...
    /**
       ...
       */
    /*if(Cookies.get('langCookie') != null && Cookies.get('langCookie') != '' ) {
        alert('window loaded ->'+Cookies.get('langCookie'));
        $("#langCode").val(Cookies.get('langCookie'));
    }*/
