                ...
                onSelected: function (selectedData) {
                    ...
                    if (selectedData.selectedData.value > 0) {
                        ...
                        var ajaxACLResources_chassis = $('#ajax_DdslickChassis').ajaxCallWidget({
                            ...
                            triggerSuccessAuto: true,
                            transactionSuccessText: window.lang.translate('Transaction successful'),
                            transactionFailureText: window.lang.translate("Service URL not found, please report error(pkStockForVehiclesGroupDdList_infostock)"),
                            dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkStockForVehiclesGroupDdList_infostock)"),
        ...
        if ($("#campaignForm").validationEngine('validate')) {
            ...
            if (!campaignID == "") {//Update
                var ajax_InsertCampaign = $('#ajaxACL-insertCampaign').ajaxCallWidget({
                    ...
                    triggerSuccessAuto: true,
                    transactionSuccessText: window.lang.translate('Transaction successful'),
                    transactionFailureText: window.lang.translate("Service URL not found, please report error(pkUpdateAct_syscampaignvehicles)"),
                    dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkUpdateAct_syscampaignvehicles)"),
                ...
                var ajax_InsertCampaign = $('#ajaxACL-insertCampaign').ajaxCallWidget({
                    ...
                    triggerSuccessAuto: true,
                    transactionSuccessText: window.lang.translate('Transaction successful'),
                    transactionFailureText: window.lang.translate("Service URL not found, please report error(pkInsertAct_syscampaignvehicles)"),
                    dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkInsertAct_syscampaignvehicles)"),
    ...
    */
    ...
    window.activepasiveCampaign = function (campaign_id, active) {
        ...
        var ajax_activepasiveCAmpaign = $('#ajaxACL-campaignList').ajaxCallWidget({
            ...
            transactionFailureText: window.lang.translate("Service URL not found, please report error(pkUpdateMakeActiveOrPassive_syscampaignvehicles)"),
            dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkUpdateMakeActiveOrPassive_syscampaignvehicles)"),
        ...
        if ($("#campaignNameForm").validationEngine('validate')) {
            ...
            if (!campNameID == "") {//Update
                var ajax_InsertCampaignName = $('#ajaxACL-insertCampaignName').ajaxCallWidget({
                    ...
                    triggerSuccessAuto: true,
                    transactionSuccessText: window.lang.translate('Transaction successful'),
                    transactionFailureText: window.lang.translate("Service URL not found, please report error(pkUpdateAct_syscampaigns)"),
                    dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkUpdateAct_syscampaigns)"),
                ...
                var ajax_InsertCampaignName = $('#ajaxACL-insertCampaignName').ajaxCallWidget({
                    ...
                    triggerSuccessAuto: true,
                    transactionSuccessText: window.lang.translate('Transaction successful'),
                    transactionFailureText: window.lang.translate("Service URL not found, please report error(pkInsertAct_syscampaigns)"),
                    dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkInsertAct_syscampaigns)"),
    ...
    */
    window.activepasiveCampaignName = function (campName_id, active) {
        ...
        var ajax_activepasiveCampaign = $('#ajaxACL-campNameList').ajaxCallWidget({
            ...
            triggerSuccessAuto: true,
            transactionSuccessText: transactionSuccessMessage,
            transactionFailureText: window.lang.translate("Service URL not found, please report error(pkUpdateMakeActiveOrPassive_syscampaigns)"),
            dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkUpdateMakeActiveOrPassive_syscampaigns)"),
            proxy: '/Campaign/SysActivePasiveCampaign',
            type: "POST",
            data: JSON.stringify({
                id: campName_id,
