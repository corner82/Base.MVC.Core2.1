$(document).ready(function () {
    var ajaxTest = $('.retail-channel-head-targets').ajaxCallWidget({
        failureLoadImage: true,
        //loadingImageID: "loading-image-wrName",
        triggerSuccessAuto: true,
        transactionSuccessText: window.lang.translate('Transaction successful'),
        transactionFailureText: window.lang.translate("Service URL not found, please report error(pkRchTargetsDashboard_dashboard)"),
        dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkRchTargetsDashboard_dashboard)"),
        proxy: '/Dashboard/AsmData',
        type: "POST",
        data: JSON.stringify({
            language_code: $("#langCode").val(),
            pk: "GsZVzEYe50uGgNM",
            url: "pkRchTargetsDashboard_dashboard"
        })
    });
        ...
        onSuccess: function (event, datatarget) {
            ...
            $.each(data.items, function (index, value) {
                ...
                template = '<div class="row" >' +
                        ...
                        '</table>' +
                    '</div>';
                $('.retail-channel-head-targets').append(template);
            });
        ...
        load: function (loadOptions) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    language_code: $("#langCode").val(),
                    pk: "GsZVzEYe50uGgNM",
                    url: "pkRchActivitiesDashboard_dashboard",
        ...
        load: function (loadOptions) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    language_code: $("#langCode").val(),
                    pk: "GsZVzEYe50uGgNM",
                    url: "pkRchActivationsDashboard_dashboard",
                    pkIdentity: $("#publicKey").val(),
                    page: "",
                    rows: "",
                    sort: "",
        ...
        load: function (loadOptions) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    language_code: $("#langCode").val(),
                    pk: "GsZVzEYe50uGgNM",
                    url: "pkRchStockDashboard_dashboard",
                    pkIdentity: $("#publicKey").val(),
                    page: "",
                    rows: "",
                    sort: "",
        ...
        load: function (loadOptions) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    language_code: $("#langCode").val(),
                    pk: "GsZVzEYe50uGgNM",
                    url: "pkRchAnnouncementsDashboard_dashboard",
                    pkIdentity: $("#publicKey").val(),
                    page: "",
                    rows: "",
                    sort: "",
