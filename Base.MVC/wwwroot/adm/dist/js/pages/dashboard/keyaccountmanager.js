$(document).ready(function () {
    ...
    var ajaxTest = $('#kam-target-table').ajaxCallWidget({
        failureLoadImage: true,
        //loadingImageID: "loading-image-wrName",
        triggerSuccessAuto: true,
        transactionSuccessText: window.lang.translate('Transaction successful'),
        transactionFailureText: window.lang.translate("Service URL not found, please report error(pkKamTargetsDashboard_dashboard)"),
        dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkKamTargetsDashboard_dashboard)"),
        proxy: '/Dashboard/AsmData',
        type: "POST",
        data: JSON.stringify({
            language_code: $("#langCode").val(),
            pk: "GsZVzEYe50uGgNM",
            url: "pkKamTargetsDashboard_dashboard"
        })
    });
    ...
    var ajaxTest = $('.kam-activites').ajaxCallWidget({
        failureLoadImage: true,
        //loadingImageID: "loading-image-wrName",
        triggerSuccessAuto: true,
        transactionSuccessText: window.lang.translate('Transaction successful'),
        transactionFailureText: window.lang.translate("Service URL not found, please report error(pkKamActivitiesDashboard_dashboard)"),
        dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkKamActivitiesDashboard_dashboard)"),
        proxy: '/Dashboard/AsmData',
        type: "POST",
        data: JSON.stringify({
            language_code: $("#langCode").val(),
            pk: "GsZVzEYe50uGgNM",
            url: "pkKamActivitiesDashboard_dashboard"
        })
    });
    ...
    ajaxTest.ajaxCallWidget({
        ...
        onSuccess: function (event, datatarget) {
            ...
            $('#kam-activites-planned h3').html(data.items[0].planned_activity);
            $('#kam-activites-completed h3').html(data.items[0].completed_activity);
            //$('#loading-image-wrName').loadImager('removeLoadImage');
        },
        onAfterSuccess: function (event, data) {
            // $('#loading-image-wrName').loadImager('removeLoadImage');
        ...
        load: function (loadOptions) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    language_code: $("#langCode").val(),
                    pk: "GsZVzEYe50uGgNM",
                    url: "pkAsmActivationsDashboard_dashboard",
        ...
        load: function (loadOptions) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    language_code: $("#langCode").val(),
                    pk: "GsZVzEYe50uGgNM",
                    url: "pkAsmAnnouncementsDashboard_dashboard",
                    pkIdentity: $("#publicKey").val(),
                    page: "",
                    rows: "",
                    sort: "",
