$(document).ready(function () {
    ...
    var ajaxTest = $('#pcdsalesman-target-table').ajaxCallWidget({
        ...
        data: JSON.stringify({
            ...
            pk: "GsZVzEYe50uGgNM",
            url: "pkPcdSalesmanTargetsDashboard_dashboard"
        })
    });
    ...
    var ajaxTest = $('.pcdsalesman-activites').ajaxCallWidget({
        failureLoadImage: true,
        //loadingImageID: "loading-image-wrName",
        triggerSuccessAuto: true,
        transactionSuccessText: window.lang.translate('Transaction successful'),
        ...
        data: JSON.stringify({
            language_code: $("#langCode").val(),
            pk: "GsZVzEYe50uGgNM",
            url: "pkPcdSalesmanActivitiesDashboard_dashboard"
        })
    });
    ...
    ajaxTest.ajaxCallWidget({
        ...
        onSuccess: function (event, datatarget) {
            ...
            $('#pcdsalesman-activites-planned h3').html(data.items[0].planned_activity);
            $('#pcdsalesman-activites-completed h3').html(data.items[0].completed_activity);
            //$('#loading-image-wrName').loadImager('removeLoadImage');
        },
        onAfterSuccess: function (event, data) {
            // $('#loading-image-wrName').loadImager('removeLoadImage');
        ...
        load: function (loadOptions) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    language_code: $("#langCode").val(),
                    pk: "GsZVzEYe50uGgNM",
                    url: "pkPcdSalesmanActivationsDashboard_dashboard",
        ...
        load: function (loadOptions) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    language_code: $("#langCode").val(),
                    pk: "GsZVzEYe50uGgNM",
                    url: "pkPcdSalesmanAnnouncementsDashboard_dashboard",
                    pkIdentity: $("#publicKey").val(),
                    page: "",
                    rows: "",
                    sort: "",
