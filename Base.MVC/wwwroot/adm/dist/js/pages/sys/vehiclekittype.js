...
$(document).ready(function () {
    ...
    /*
    * vehiclekittype LoadImager
    * @author Gül Özdemir
    * @since 14/08/2016
    */
    //to vehiclekittype form
    $("#loading-image-vehiclekittype").loadImager();
    //to brand form grid loading-image
    $("#loading-image-vehiclekittypeGrid").loadImager();
   
    var langCode = $("#langCode").val();
    //alert(langCode);


    $('#vehiclekittypeForm').validationEngine();
    ...
    $("#gridContainer_vehiclekittype").dxDataGrid({
 ...
 */
    ...
    window.resetVehicleKitTypeForm = function () {
        $("#loading-image-vehiclekittype").loadImager('removeLoadImage');
        $("#loading-image-vehiclekittype").loadImager('appendImage');

        $('#vehiclekittypeForm').validationEngine('hide');
    ...
    */
    ...
    window.insertVehicleKitTypeWrapper = function (e) {
        ...
        if ($("#vehiclekittypeForm").validationEngine('validate')) {
    ...
    */
    ...
    window.fillVehicleKitTypeForm = function (data) {
        $("#loading-image-vehiclekittype").loadImager('removeLoadImage');
        $("#loading-image-vehiclekittype").loadImager('appendImage');

        document.getElementById("txt-vehiclekittype-name").value = data.Employee;
