...
//Off Road
    ...
    var ajaxACLResources_BbOffRoad = $('#ajax_DdslickBbOffRoad').ajaxCallWidget({
        ...
        dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkTerrainsBuybackDdList_systerrains)"),
...
//Mil
    ...
    var ajaxACLResources_BbMileage = $('#ajax_DdslickBbMileage').ajaxCallWidget({
        ...
        triggerSuccessAuto: true,
        transactionSuccessText: window.lang.translate('Transaction successful'),
        transactionFailureText: window.lang.translate("Service URL not found, please report error(pkMileagesBuybackDdList_sysmileages)"),
        dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkMileagesBuybackDdList_sysmileages)"),
...
//Month
    ...
    var ajaxACLResources_BbMonths = $('#ajax_DdslickBbMonths').ajaxCallWidget({
        ...
        triggerSuccessAuto: true,
        transactionSuccessText: window.lang.translate('Transaction successful'),
        transactionFailureText: window.lang.translate("Service URL not found, please report error(pkBuybackMonthsDdList_sysmonths)"),
        dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkBuybackMonthsDdList_sysmonths)"),
        proxy: '/DefaultPost/DefaultPostModel',
        type: "POST",
        data: JSON.stringify({
            language_code: $("#langCode").val(),
...
//Customer Type
    ...
    var ajaxACLResources_BbCustomerType = $('#ajax_DdslickBbCustomerType').ajaxCallWidget({
        ...
        dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkCustomerTypesDdList_syscustomertypes)"),
...
//TruckType
    ...
    var ajaxACLResources_BbTruckType = $('#ajax_DdslickBbTruckType').ajaxCallWidget({
        ...
        triggerSuccessAuto: true,
        transactionSuccessText: window.lang.translate('Transaction successful'),
        transactionFailureText: window.lang.translate("Service URL not found, please report error(pkVehiclesBbDefDdList_sysvehiclestrade)"),
        dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkVehiclesBbDefDdList_sysvehiclestrade)"),
        proxy: '/DefaultPost/DefaultPostModel',
        type: "POST",
        data: JSON.stringify({
            language_code: $("#langCode").val(),
...
//http://proxy.mansis.co.za:18443/SlimProxyBoot.php?url=pkTerrainsTradebackDdList_systerrains&language_code=en&pk=GsZVzEYe50uGgNM
    ...
    var ajaxACLResources_BbOffRoad = $('#ajax_DdslickTbOffRoad').ajaxCallWidget({
        ...
        dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkTerrainsTradebackDdList_systerrains)"),
        proxy: '/BuybackTradeback/SysBbTerrains',
        type: "POST",
        data: JSON.stringify({
            language_code: $("#langCode").val(),
...
//Mil
    ...
    var ajaxACLResources_TbMileage = $('#ajax_DdslickTbMileage').ajaxCallWidget({
        ...
        triggerSuccessAuto: true,
        transactionSuccessText: window.lang.translate('Transaction successful'),
        transactionFailureText: window.lang.translate("Service URL not found, please report error(pkMileagesTradebackDdList_sysmileages)"),
        dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkMileagesTradebackDdList_sysmileages)"),
        proxy: '/DefaultPost/DefaultPostModel',
        type: "POST",
        data: JSON.stringify({
            language_code: $("#langCode").val(),
...
//Month
    ...
    var ajaxACLResources_TbMonths = $('#ajax_DdslickTbMonths').ajaxCallWidget({
        ...
        triggerSuccessAuto: true,
        transactionSuccessText: window.lang.translate('Transaction successful'),
        transactionFailureText: window.lang.translate("Service URL not found, please report error(pkTradebackMonthsDdList_sysmonths)"),
        dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkTradebackMonthsDdList_sysmonths)"),
        proxy: '/DefaultPost/DefaultPostModel',
        type: "POST",
        data: JSON.stringify({
            language_code: $("#langCode").val(),
...
//TruckType
    ...
    var ajaxACLResources_TbTruckType = $('#ajax_DdslickTbTruckType').ajaxCallWidget({
        ...
        triggerSuccessAuto: true,
        transactionSuccessText: window.lang.translate('Transaction successful'),
        transactionFailureText: window.lang.translate("Service URL not found, please report error(pkVehiclesTbDefDdList_sysvehiclestrade)"),
        dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkVehiclesTbDefDdList_sysvehiclestrade)"),
        proxy: '/DefaultPost/DefaultPostModel',
        type: "POST",
        data: JSON.stringify({
            language_code: $("#langCode").val(),
        ...
        if ($("#buybackInfoForm").validationEngine('validate')) {
            ...
            if (!buybackId == "") {//update
                var ajax_InsertMatrix = $('#ajaxACL-insertBuyback').ajaxCallWidget({
                    ...
                    triggerSuccessAuto: true,
                    transactionSuccessText: window.lang.translate('Transaction successful'),
                    transactionFailureText: window.lang.translate("Service URL not found, please report error(pkUpdateBBAct_sysbuybackmatrix)"),
                    dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkUpdateBBAct_sysbuybackmatrix)"),
                ...
                var ajax_InsertMatrix = $('#ajaxACL-insertBuyback').ajaxCallWidget({
                    ...
                    triggerSuccessAuto: true,
                    transactionSuccessText: window.lang.translate('Transaction successful'),
                    transactionFailureText: window.lang.translate("Service URL not found, please report error(pkInsertBBAct_sysbuybackmatrix)"),
                    dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkInsertBBAct_sysbuybackmatrix)"),
...
*/
    ...
    window.activepasiveBuyback = function (buyback_id, active) {
        ...
        var ajax_activepasiveBuyback = $('#ajaxACL-buybackList').ajaxCallWidget({
            ...
            triggerSuccessAuto: true,
            transactionSuccessText: window.lang.translate('Transaction successful'),
            transactionFailureText: window.lang.translate("Service URL not found, please report error(pkUpdateMakeActiveOrPassive_sysbuybackmatrix)"),
            dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkUpdateMakeActiveOrPassive_sysbuybackmatrix)"),
        ...
        if ($("#tradebackInfoForm").validationEngine('validate')) {
            ...
            if (!tradebackId == "") {//update
                var ajax_InsertMatrix = $('#ajaxACL-insertTradeback').ajaxCallWidget({
                    ...
                    triggerSuccessAuto: true,
                    transactionSuccessText: window.lang.translate('Transaction successful'),
                    transactionFailureText: window.lang.translate("Service URL not found, please report error(pkUpdateTBAct_sysbuybackmatrix)"),
                    dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkUpdateTBAct_sysbuybackmatrix)"),
                ...
                var ajax_InsertMatrix = $('#ajaxACL-insertTradeback').ajaxCallWidget({
                    ...
                    triggerSuccessAuto: true,
                    transactionSuccessText: window.lang.translate('Transaction successful'),
                    transactionFailureText: window.lang.translate("Service URL not found, please report error(pkInsertTBAct_sysbuybackmatrix)"),
                    dataAlreadyExistsText: window.lang.translate("Data already created, edit your data(pkInsertTBAct_sysbuybackmatrix)"),
