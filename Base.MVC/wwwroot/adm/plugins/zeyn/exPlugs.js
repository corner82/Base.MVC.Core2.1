    ...
    */
    $.widget("sanalfabrika.ajaxCallWidget", {
        ...
        options: {
            ...
            dataModelCorruptFailureText: 'missing data, please control',
            numericValueOutofRangeFailureText: 'SQL syntax html decode error',
            sqlSyntaxDecodeFailureText: 'SQL syntax html decode error',
            dateFormatFailureText: 'Datetime format error',
            divisionByZeroFailureText: 'Division by zero error',
            columnSizeFailureText: 'Data size is bigger than allowed',
            foregnKeyExistsText: 'Foreign key restriction',
            dataAlreadyExistsText: 'data already exists, please control',
            transactionFailureText: 'Service link error',
            noDataFailureText: 'Service data not found, please control',
