...
(function ($) {
    ...
    $.widget("sanalfabrika.tagCabin", {
        ...
        options: {
            ...
            closeTag: '<i class="fa fa-fw fa-trash-o delete-icon" title="Delete" onclick=""></i>',
            closeAllTag: '<i class="fa fa-fw fa-remove delete-all-icon" title="Delete All" onclick=""></i>',
            copyTag: '<i class="fa fa-copy copy-icon" title="Copy" onclick=""></i>',
