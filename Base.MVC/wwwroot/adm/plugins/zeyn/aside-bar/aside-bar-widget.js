...
(function ($) {
    ...
    $.widget("miya.asidebar", {
        ...
        options: {
            ...
            asideTop: "50px",
            asideZIndex: "1000",
            asidePadding: "0px 10px 10px 10px",
            asideFloat: "right",
        ...
        addAsideHtml: function (id, tag, infoArray) {
            var self = $(this);
            self.append("<aside style='float:right;background-color: #343a38;color: #d2d6de;width: 250px;position: absolute;top: 50px;z-index:1000;right: 0px;padding: 0px 10px 10px 10px;'>");
           /* var tag = tag;
            var icons = '';
            var tagCustom = '';
        ...
        * BugFix#3 01/12/2017
        ...
        _create: function () {
             ...
             */
            this._on(this.element, {
                'click.testClass': function (event, self) {
                    var event = event;
                    //var element = $(event.target).parent();
                    //var id = element.attr('data-attribute');
                    this._trigger('selectorClick', event, {
                        /*element: element,
                        id: id*/
                    });
                }
