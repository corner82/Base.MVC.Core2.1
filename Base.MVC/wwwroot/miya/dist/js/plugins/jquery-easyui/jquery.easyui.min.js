...
(function ($) {
    ...
    function _35d(_35e, _35f, pp) {
        ...
        pp.panel($.extend({}, _35f, {
            tab: tab, border: false, noheader: true, closed: true, doSize: false, iconCls: (_35f.icon ? _35f.icon : undefined), onLoad: function () {
                if (_35f.onLoad) {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 27, selected: 0, showHeader: true, plain: false, fit: false, border: true, justified: false, narrow: false, pill: false, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_3a6) {
...
(function ($) {
    ...
    function _3e2(_3e3, _3e4, _3e5) {
        ...
        function _3e9(dir) {
            ...
            p.panel($.extend({}, $.fn.layout.paneldefaults, {
                cls: ("layout-expand layout-expand-" + dir), title: "&nbsp;", titleDirection: _3e7.titleDirection, iconCls: (_3e7.hideCollapsedContent ? null : _3e7.iconCls), closed: true, minWidth: 0, minHeight: 0, doSize: false, region: _3e7.region, collapsedSize: _3e7.collapsedSize, noheader: (!isns && _3e7.hideExpandTool), tools: ((isns && _3e7.hideExpandTool) ? null : [{
    ...
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, {
        region: null, split: false, collapsedSize: 28, expandMode: "float", hideExpandTool: false, hideCollapsedContent: true, collapsedContent: function (_41b) {
            var p = $(this);
...
(function ($) {
    ...
    $.fn.menu.defaults = {
        zIndex: 110000, left: 0, top: 0, alignTo: null, align: "left", minWidth: 120, itemHeight: 22, duration: 100, hideOnUnhover: true, inline: false, fit: false, noline: false, events: { mouseenter: _436, mouseleave: _439, mouseover: _43d, mouseout: _440, click: _442 }, position: function (_472, left, top) {
            return { left: left, top: top };
        }, onShow: function () {
        }, onHide: function () {
...
(function ($) {
    ...
    $.fn.switchbutton.defaults = {
        handleWidth: "auto", width: 60, height: 26, checked: false, disabled: false, readonly: false, reversed: false, onText: "ON", offText: "OFF", handleText: "", value: "on", onChange: function (_4bb) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        passwordChar: "%u25CF", checkInterval: 200, lastDelay: 500, revealed: false, showEye: true, inputEvents: { focus: _55c, blur: _560 }, val: function (_569) {
...
(function ($) {
    ...
    function _693(_694) {
        ...
        if (opts.pagination) {
            ...
            _69b.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_69c, _69d) {
    ...
    function _6aa(_6ab) {
        ...
        _6b0.each(function () {
            $(this).resizable({
                handles: _6b1, edge: opts.resizeEdge, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _6ac.resizing = true;
...
(function ($) {
    ...
    function _8ae(_8af) {
        ...
        $(_8af).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_8b1, row) {
...
(function ($) {
    function _8ff(_900) {
        ...
        if (opts.pagination) {
            ...
            _90c.pagination({
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_90d, _90e) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, animate: false, singleSelect: true, view: _9a4, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _91a(true), mouseout: _91a(false), click: _91c }), loader: function (_9e2, _9e3, _9e4) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
...
(function ($) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _9f4, textFormatter: function (_a10, row) {
            return _a10;
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _a25, keydown: _a29, paste: _a29, drop: _a29 }, panelEvents: {
            mousedown: function (e) {
                e.preventDefault();
                e.stopPropagation();
            }
        }, panelWidth: null, panelHeight: 200, panelMinWidth: null, panelMaxWidth: null, panelMinHeight: null, panelMaxHeight: null, panelAlign: "left", reversed: false, multiple: false, multivalue: true, selectOnNavigation: true, separator: ",", hasDownArrow: true, delay: 200, keyHandler: {
            up: function (e) {
            }, down: function (e) {
            }, left: function (e) {
            }, right: function (e) {
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupPosition: "static", groupField: null, groupFormatter: function (_ab2) {
            return _ab2;
        }, mode: "local", method: "post", url: null, data: null, queryParams: {}, showItemIcon: false, limitToList: false, unselectedValues: [], mappingRows: [], view: _aad, keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
...
(function ($) {
    ...
    $.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
        hasDownArrow: false, multiple: true, reversed: true, selectOnNavigation: false, tipOptions: $.extend({}, $.fn.textbox.defaults.tipOptions, { showDelay: 200 }), val: function (_b8a) {
...
(function ($) {
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_c1a) {
            return _c1a;
        }, converter: {
