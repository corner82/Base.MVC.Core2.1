...
(function (root, factory) {
    ...
    BootstrapDialog.prototype = {
        ...
        createModalContent: function () {
            return $('<div class="modal-content " style="border-radius:6px;padding:0px;border:0px;"></div>');
        },
        ...
        createModalHeader: function () {
            return $('<div class="modal-header" style="padding:13px;"></div>');
        },
        ...
        createModalBody: function () {
            return $('<div class="modal-body" style="padding: 13px;"></div>');
        },
        ...
        createModalFooter: function () {
            return $('<div class="modal-footer" style="padding:13px; text-align:right;"></div>');
        },
