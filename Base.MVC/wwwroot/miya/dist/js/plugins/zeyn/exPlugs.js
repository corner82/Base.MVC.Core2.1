...
(function ($) {
    ...
    /*setTimeout(function(){
        ...
        $textAndPic.append('<img src="https://sorubankasi.com/dist/img/ostim_logo_en.png" />');
        $textAndPic.append('<img src="https://sorubankasi.com/onyuz/standard/assets/img/logo1-default.png" />');
     ...
     * @since 11/01/2016
     */
    $.widget("sanalfabrika.enumCreater", {
        _init: function () {
        },
        /**
         * Default options.
         ...
         * @returns {null}
         */
        getCityEnum: function () {
            var self = this;
            var enumTest = [{ "text": "L\u00fctfen Se\u00e7iniz", "value": 0, "selected": true, "imageSrc": "", "description": "" },
                { "text": "Ankara", "value": 8, "selected": false, "description": "" },
                { "text": "İstanbul", "value": 7, "selected": false, "description": "" },
                { "text": "İzmir", "value": 6, "selected": false, "description": "" },
                { "text": "Antalya", "value": 5, "selected": false, "description": "" },
                { "text": "Bursa", "value": 4, "selected": false, "description": "" },
                { "text": "Konya", "value": 3, "selected": false, "description": "" },
                { "text": "Orta Okul", "value": 2, "selected": false, "description": "" }];
            return enumTest;
        },
        getReasonEnum: function () {
            var self = this;
            var enumTest = [{ "text": "Seçiniz", "value": 0, "selected": false, "description": "" },
            { "text": "İlk Defa", "value": 1, "selected": false, "description": "" },
            { "text": "Süre Dolumu Nedeni İle Yenileme", "value": 2, "selected": false, "description": "" },
            { "text": "Diğer", "value": 3, "selected": false, "description": "" }];
            return enumTest;
        },
        getCountryEnum: function () {
            var self = this;
            var enumTest = [{ "text": "Seçiniz", "value": 0, "selected": false, "description": "" },
            { "text": "Türkiye", "value": 1, "selected": false, "description": "" },
            { "text": "İthalat", "value": 2, "selected": false, "description": "" }];
            return enumTest;
        }
    });
    ...
    $.widget('sanalfabrika.dateExt', {
        ...
        dateTimeToFormat: function (dateTimeData) {
            if (dateTimeData != '' && dateTimeData != null) {
                dateTimeData.trim();
                var dateTimeDataArr = dateTimeData.split('-');
                //console.log(dateTimeDataArr);
                var day = dateTimeDataArr[2].substring(0, 2);
                var year = dateTimeDataArr[0];
                var month = dateTimeDataArr[1];
        ...
        formatToDateTime: function (dateTimeData) {
            if (dateTimeData != '' && dateTimeData != null) {
                dateTimeData.trim();
                var dateTimeDataArr = dateTimeData.split('/');
                //console.log(dateTimeDataArr);
                var day = dateTimeDataArr[0];
                var year = dateTimeDataArr[2];
                var month = dateTimeDataArr[1];
                var date = new Date();
                var hour = date.getHours();     // yields hours 
                var minute = date.getMinutes(); // yields minutes
                var second = date.getSeconds();
                var newDateStr = day + '/' + month + '/' + year + " " + hour + ':' + minute + ':' + second;
                //console.log(newDateStr);
                return newDateStr;
            } else {
                return '';
        ...
        formatToDateTimeExtended : function (dateTimeData) {
            if (dateTimeData != '' && dateTimeData != null) {
                dateTimeData.trim();
                var dateTimeDataArr = dateTimeData.split('/');
                /*var date = new Date();
                ...
                var minute = date.getMinutes(); // yields minutes
                var second = date.getSeconds();
                //"HarvestDate": day + "/" + month + "/" + year + " " + hour + ':' + minute + ':' + second,*/
                var newDateStr = day + '/' + month + '/' + year;
                //console.log(newDateStr);
                return newDateStr;
            } else {
